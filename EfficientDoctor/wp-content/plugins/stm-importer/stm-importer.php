				...
				<div class="stm_demo_import_choices">
					...
					<label>
						...
						<span class="stm_choice_radio_button">
							...
							<?php esc_html_e('Demo Ten', 'stm-importer'); ?>
						</span>
					</label>
					<label>
						...
						<span class="stm_choice_radio_button">
							...
							<?php esc_html_e('Demo Eleven', 'stm-importer'); ?>
						</span>
					</label>
					<label>
						...
						<span class="stm_choice_radio_button">
							...
							<?php esc_html_e('Demo Twelve', 'stm-importer'); ?>
						</span>
					</label>
					<label>
						...
						<span class="stm_choice_radio_button">
							...
							<?php esc_html_e('Demo Thirteen', 'stm-importer'); ?>
						</span>
					</label>
					<label>
						...
						<span class="stm_choice_radio_button">
							...
							<?php esc_html_e('Demo Fourteen', 'stm-importer'); ?>
						</span>
					</label>
					<label>
						...
						<span class="stm_choice_radio_button">
							...
							<?php esc_html_e('Demo Fifteen', 'stm-importer'); ?>
						</span>
					</label>
				</div>
