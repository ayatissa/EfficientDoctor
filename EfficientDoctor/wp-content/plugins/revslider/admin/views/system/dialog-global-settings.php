				...
				<tbody>
					...
					<tr id="show_dev_export_row" valign="top">
						...
						<td>
							...
							<div class="description_container">
								<span class="description"><?php _e("Insert something in it and it will be used instead of https://fonts.googleapis.com/css?family= (For example: https://fonts.useso.com/css?family= which will also work for chinese visitors)",'revslider'); ?></span>				
							</div>
						</td>
					</tr>
