								...
								<?php if( consulting_get_header_style() == 'header_style_6' ) : ?>
									<?php if ( class_exists( 'WooCommerce' ) && $wc_topbar_cart_hide ): ?>
										<div class="cart_count_wrapper">
											<a href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" class="cart_count"><i class="stm-shopping-cart8"></i><span class="count"><?php esc_html_e( WC()->cart->get_cart_contents_count() ); ?></span></a>
										</div>
									<?php endif; ?>
									<?php
									...
									<ul class="top_bar_contacts">
										...
										<?php if ( ! empty( $top_bar_contact_email ) ): ?>
											<li>
												...
												<div class="top_bar_contacts_text"><a href="mailto:<?php echo esc_url( $top_bar_contact_email ); ?>"><?php esc_html_e( $top_bar_contact_email, true ); ?></a></div>
											</li>
										<?php endif; ?>
											...
											<div class="stm_top_bar_l13-center">
												<?php if(!empty($stm_work_hours_l13)): ?>
													<div class="stm_top_bar_unit_l13">
														...
														<span class="top_bar_contacts_text"><?php echo wp_kses_post( $stm_work_hours_l13 ); ?></span>
													</div>
												<?php endif; ?>
										...
										<?php else: ?>
											<?php if ( count( $top_bar_info ) > 1 ): ?>
												<div class="top_bar_info_switcher">
													<div class="active">
														<span><?php esc_html_e( $top_bar_info[1]['office'], true ); ?></span>
													</div>
													<ul>
														<?php foreach ( $top_bar_info as $key => $val ): ?>
															<li>
																<a href="#top_bar_info_<?php echo esc_attr( $key ); ?>"><?php esc_html_e( $val['office'], true ); ?></a>
															</li>
														<?php endforeach; ?>
													</ul>
												</div>
													...
													<ul class="top_bar_info" id="top_bar_info_<?php echo esc_attr( $key ); ?>"<?php if ( $key == 1 ) { echo ' style="display: block;"'; } ?>>
														...
														<?php if ( ! empty( $val['hours'] ) ): ?>
															<li>
																...
																<span><?php esc_html_e( $val['hours'], true ); ?></span>
															</li>
														<?php endif; ?>
														<?php if ( !empty( $val['phone'] ) ): ?>
															<li>
																<i class="<?php echo esc_attr( $val['phone_icon'] ); ?>"></i>
																<span><?php esc_html_e( $val['phone'], true ); ?></span>
															</li>
														<?php endif; ?>
													</ul>
												<?php endforeach; ?>
										...
										<div class="">
											<div class="header_socials">
												...
												<?php if(consulting_get_header_style() == 'header_style_4' && $consulting_config['layout'] == 'layout_13' && class_exists( 'WooCommerce' ) && ! $wc_cart_hide ): ?>
													<a href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" class="cart_count"><i class="stm-cart_13"></i><span class="count"><?php esc_html_e( WC()->cart->get_cart_contents_count() ); ?></span></a>
												<?php endif; ?>
											</div>
										</div>
									<?php endif; ?>
									...
									<?php if ( $socials = consulting_get_socials() ): ?>
										<div class="header_socials">
											...
											<?php if ( class_exists( 'WooCommerce' ) && ! $wc_cart_hide ): ?>
												<a href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" class="cart_count"><i class="stm-cart-2"></i><span class="count"><?php esc_html_e( WC()->cart->get_cart_contents_count() ); ?></span></a>
											<?php endif; ?>
										</div>
									<?php endif; ?>
									<div class="top_nav_wrapper clearfix">
