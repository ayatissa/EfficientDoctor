...
$footer_layout = array(
	...
	'footer_copyright'     => array(
		'label'       => esc_html__( 'Copyright', 'consulting' ),
		'placeholder' => esc_html__( "Copyright &copy; 2012-2016 Consulting Theme by <a href='http://stylemixthemes.com/' target='_blank'>Stylemix Themes</a>. All rights reserved", 'consulting' ),
		'default'     => esc_html__( "Copyright &copy; 2012-2016 Consulting Theme by <a href='http://stylemixthemes.com/' target='_blank'>Stylemix Themes</a>. All rights reserved", 'consulting' ),
		'type'        => 'stm-text'
	),
);
...
STM_Customizer::setSection( 'envato_api_settings', array(
	...
	'fields'   => array(
		'envato_username' => array(
			...
			'type'  => 'text',
			'default' => '',
			'description' => esc_html__( 'Enter here your ThemeForest (or Envato) username account (i.e. Stylemixthemes).', 'consulting' )
		),
		'envato_api' => array(
			'label' => esc_html__( 'Envato API Key', 'consulting' ),
			'type'  => 'text',
			'default' => '',
			'description' => esc_html__( 'Enter here the secret api key you have created on ThemeForest. You can create a new one in the Settings > API Keys section of your profile.', 'consulting' )
		),
	)
) );

STM_Customizer::setSection( 'google_api_settings', array(
	'title'    => esc_html__( 'Google Api Settings', 'consulting' ),
	'panel'    => 'site_settings',
	'priority' => 300,
	'fields'   => array(
		'google_api_key' => array(
			'label' => esc_html__( 'Google API Key', 'consulting' ),
			'type'  => 'text',
