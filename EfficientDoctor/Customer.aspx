<%@ Page Title="" Language="C#" Theme="ITC_Theme" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="EfficientDoctor.Customer" %>
...
<br />
        ...
        <div class="main_appsi" id="apps">
            ...
            <dx:ASPxGridView ID="gvCustomer" ClientInstanceName="gvCustomer" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="CusID" VisibleIndex="0" Name="CusID" ReadOnly="True">
